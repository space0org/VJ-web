...
function App() {
  ...
  return (
    <div className="fixed inset-0 bg-black">
      <div ref={sketchRef} className="absolute top-0 left-0 right-0 bottom-[160px]" />
      <div className="fixed bottom-0 left-0 right-0 h-[160px] bg-white flex flex-col items-center justify-center gap-4 border-t border-gray-200 shadow-lg">
