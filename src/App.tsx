...
function App() {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-black">
      <div ref={sketchRef} className="w-full" style={{ height: 'calc(100vh - 160px)' }} />
      <footer className="fixed bottom-0 left-0 right-0 bg-white py-6 flex flex-col items-center justify-center gap-4 border-t border-gray-200">
