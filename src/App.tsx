...
function App() {
  ...
  return (
    <div className="relative w-screen h-screen bg-black overflow-hidden">
      <div ref={sketchRef} className="absolute inset-0 bottom-[160px]" />
      <div className="absolute bottom-0 left-0 right-0 h-[160px] bg-white flex flex-col items-center justify-center gap-4 border-t border-gray-200 shadow-lg z-50">
